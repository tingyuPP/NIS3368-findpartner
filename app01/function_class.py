...
class User:
    def __init__(self, user_id, passwords, nickname = "user%s" % id, sex = "unknown", hobby = "unknown", introduction = "unknown", my_notice_id_list = None,  request_notice_id_list = None):
